...
export const Header: React.FC<HeaderProps> = ({ templateStyle }) => {
  ...
  return (
    <div style={{
      ...
      {/* 헤더 제목 */}
      <div style={{
        fontSize: headerStyle.fontSize || THEME_CONSTANTS.TYPOGRAPHY.HEADER_TITLE_SIZE,
        fontWeight: headerStyle.fontWeight || 700,
        fontFamily: headerStyle.fontFamily || THEME_CONSTANTS.FONTS.PRIMARY,
